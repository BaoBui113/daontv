...
import icon_home from "@/app/assets/icons/icon-home.svg";
import icon_movie from "@/app/assets/icons/icon-movie.svg";
import icon_camera from "@/app/assets/icons/icon-camera.svg";
import icon_watching from "@/app/assets/icons/icon-watching.svg";
import icon_showmore from "@/app/assets/icons/icon-show-more.svg";
const categories = [
  {
    image: icon_home,
    title: "홈",
